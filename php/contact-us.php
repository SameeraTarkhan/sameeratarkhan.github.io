...
<html lang="zxx">
  ...
  <body class=" dark-theme ">
    ...
    <section class="contact-us  mega-section  pb-0" id="contact-us">
      <div class="container">
        <section class="locations-section  mega-section section">
          <div class="sec-heading centered  ">
            <div class="content-area">
              <h2 class=" title    wow fadeInUp" data-wow-delay=".4s">our office location</h2>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-12 col-lg-4">   
                  <div class="info-panel  wow fadeInUp" data-wow-delay=".6s">
                    <h4 class="location-title">Amman </h4>
                    <div class="line-on-side "> </div>
                    <p class="location-address">Amman, Jordan</p>
                    <div class="location-card  "><i class="flaticon-email icon"></i>
                      <div class="card-content">
                        <h6 class="content-title">email:</h6><a class="email link" href="mailto:yourname@example.com">info@thru-tech.com</a>
                      </div>
                    </div>
                    <div class="location-card  "><i class="flaticon-phone-call icon"></i>
                      <div class="card-content">
                        <h6 class="content-title">phone:</h6><a class="tel link" href="tel:966 11 478 6527
                        ">+966 11 478 6527
                        </a>
                      </div>
                    </div>
                ...
                <div class="col-12 col-lg-4">           
                  <div class="info-panel  wow fadeInUp" data-wow-delay=".6s">
                    <h4 class="location-title">Ras Al Khaimah</h4>
                    <div class="line-on-side "> </div>
                    <p class="location-address">Ras Al Khaimah, United Arab Emirates
                    </p>
                    <div class="location-card  "><i class="flaticon-email icon"></i>
                      <div class="card-content">
                        <h6 class="content-title">email:</h6><a class="email link" href="mailto:yourname@example.com">info@thru-tech.com</a>
                ...
                <div class="col-12 col-lg-4">
                  <div class="info-panel  wow fadeInUp" data-wow-delay=".6s">
                    <h4 class="location-title">Riyadh </h4>
                    <div class="line-on-side "> </div>
                    <p class="location-address">Riyadh, Kingdom of Saudi Arabia</p>
                    <div class="location-card  "><i class="flaticon-email icon"></i>
                      <div class="card-content">
                        <h6 class="content-title">email:</h6><a class="email link" href="mailto:yourname@example.com">info@thru-tech.com</a>
                      </div>
        ...
        <section class="map-section  elf-section section">
          <div class="sec-heading  centered   ">
            <div class="content-area">
          ...
          <div class="map-box  wow fadeInUp" data-wow-delay=".6s">
            <div class="mapouter">
              <div class="gmap_canvas">
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3621.483884116213!2d46.648637525121536!3d24.81312057796018!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2ee49c2f103c53%3A0x399a98a9096d52af!2z2KPZhNmI2KfZhiDYs9mG2KrYsQ!5e0!3m2!1sar!2sjo!4v1728563537271!5m2!1sar!2sjo" 
        ...
        <section class="contact-us-form-section  mega-section section">
          <div class="row">
            <div class="col-12 ">
              <div class="contact-form-panel">
                ...
                <div class="contact-form-inputs wow fadeInUp" data-wow-delay=".6s">
                  <div class="custom-form-area input-boxed"> 
                    ...
                    <form class="main-form" id="contact-us-form" action="send-mail.php" method="post"><span class="done-msg"></span>
                      <div class="row ">
    ...
    <footer class="page-footer dark-color-footer" id="footer">
      ...
      <div class="container">
        <div class="row footer-cols">
          <div class="col-12 col-md-8 col-lg-5 footer-col">
            <img
            ...
            <div class="footer-col-content-wrapper">
              <p class="footer-text-about-us">
                THRU is a pioneering company at the forefront of delivering
                exceptional and groundbreaking experiences across diverse
                sectors through advanced technologies such as Virtual Reality
                (VR), Augmented Reality (AR), Mixed Reality (MR), and the
                Metaverse.
              </p>
            </div>
            <div class="col-12 col-md-12 d-flex justify-content-start">
              <p class="creadits" id="creadits" id="creadits">
                &copy; 2024 Created by:
                <a class="link" href="#0">Thru-tech</a>
              </p>
            </div>
          </div>
          <div class="col-6 col-lg-1 footer-col"></div>
          <div class="col-6 col-lg-2 footer-col"></div>
            ...
            <div class="footer-col-content-wrapper">
              ...
              <div class="contact-info-card">
                ...
                ><span class="text-lowercase info"
                  >King Abdul Aziz Branch Rd, As Sahafah, Riyadh 13321, Alwan
                  Center, First Floor, Office 45.</span
                >
              </div>
              <div class="contact-info-card">
                <div class="social-icons">
                  <div class="sc-wrapper dir-row sc-size-32">
                    ...
                    <li class="sc-item" title="Linkedin">
                        <a class="sc-link" href="https://www.linkedin.com/company/thru-technlogies/posts/?feedView=all" title="social media icon"
    ...
    <div class="loading-screen" id="loading-screen">
      ...
      <span class="loading-counter">Loading...</span>
    </div>
